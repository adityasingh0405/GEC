    ...
    <ol className="relative border-l-2 border-[#DDE3EC] ml-4 space-y-8">
      {items.map((item, index) => (
        <li key={index} className="ml-6">
          {/* Dot */}
          <span
            className="absolute -left-[11px] w-5 h-5 rounded-full border-2 border-[#1E3A5F] bg-white flex items-center justify-center"
            aria-hidden="true"
          >
          ...
          {/* Year badge */}
          <span className="inline-block text-xs font-bold text-[#C8972B] bg-[#C8972B]/10 px-2.5 py-0.5 rounded-full mb-2">
            {item.year}
          </span>
