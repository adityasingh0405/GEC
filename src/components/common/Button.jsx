...
const variants = {
  primary: [
    ...
    'hover:bg-[#2A5284] active:bg-[#152940]',
  ...
  secondary: [
    ...
    'hover:bg-[#1E3A5F] hover:text-white active:bg-[#152940]',
    'focus-visible:ring-2 focus-visible:ring-[#C8972B] focus-visible:ring-offset-2',
    'transition-all duration-200',
    'font-semibold rounded-lg',
  ].join(' '),
  accent: [
    ...
    'hover:bg-[#A87820] active:bg-[#8B640F]',
  ...
  ghost: [
    ...
    'hover:bg-white/10 hover:border-white active:bg-white/20',
